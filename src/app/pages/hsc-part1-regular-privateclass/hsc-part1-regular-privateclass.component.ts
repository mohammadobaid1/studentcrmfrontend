...
@Component({
  selector: 'app-hsc-part1-regular-privateclass',
  templateUrl: './hsc-part1-regular-privateclass.component.html',
  styleUrls: ['./hsc-part1-regular-privateclass.component.scss']
})
export class HscPart1RegularPrivateclassComponent extends BasePageComponent implements OnInit  {
