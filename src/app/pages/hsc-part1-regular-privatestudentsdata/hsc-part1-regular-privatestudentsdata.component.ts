...
@Component({
  selector: 'app-hsc-part1-regular-privatestudentsdata',
  templateUrl: './hsc-part1-regular-privatestudentsdata.component.html',
  styleUrls: ['./hsc-part1-regular-privatestudentsdata.component.scss']
})
export class HscPart1RegularPrivatestudentsdataComponent extends BasePageComponent implements OnInit {
