...
@Component({
  selector: 'app-hsc-part1-pre-engineeringstudentsdata',
  templateUrl: './hsc-part1-pre-engineeringstudentsdata.component.html',
  styleUrls: ['./hsc-part1-pre-engineeringstudentsdata.component.scss']
})
export class HscPart1PreEngineeringstudentsdataComponent extends BasePageComponent implements OnInit {
