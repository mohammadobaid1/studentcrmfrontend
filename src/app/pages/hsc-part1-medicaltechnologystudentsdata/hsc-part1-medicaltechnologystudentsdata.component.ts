...
@Component({
  selector: 'app-hsc-part1-medicaltechnologystudentsdata',
  templateUrl: './hsc-part1-medicaltechnologystudentsdata.component.html',
  styleUrls: ['./hsc-part1-medicaltechnologystudentsdata.component.scss']
})
export class HscPart1MedicaltechnologystudentsdataComponent extends BasePageComponent implements OnInit {
