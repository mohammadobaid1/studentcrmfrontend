...
@Component({
  selector: 'app-matricregularstudentsdata',
  templateUrl: './matricregularstudentsdata.component.html',
  styleUrls: ['./matricregularstudentsdata.component.scss']
})
export class MatricregularstudentsdataComponent extends BasePageComponent implements OnInit {
