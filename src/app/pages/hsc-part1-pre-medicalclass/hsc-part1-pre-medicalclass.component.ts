...
@Component({
  selector: 'app-hsc-part1-pre-medicalclass',
  templateUrl: './hsc-part1-pre-medicalclass.component.html',
  styleUrls: ['./hsc-part1-pre-medicalclass.component.scss']
})
export class HscPart1PreMedicalclassComponent extends BasePageComponent implements OnInit  {
  ...
  ngOnInit() {
    ...
    this.form = this.forminstance.getPreMedicalclassform();
    this.getstudentdataform =  this.forminstance.getstudentdemographicdata();
     ...
     this.httpSv.addPremedicaldata(this.form.value)
      .subscribe(data=>{
