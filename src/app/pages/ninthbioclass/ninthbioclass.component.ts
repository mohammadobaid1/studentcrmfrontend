...
@Component({
  selector: 'app-ninthbioclass',
  templateUrl: './ninthbioclass.component.html',
  styleUrls: ['./ninthbioclass.component.scss']
})
export class NinthbioclassComponent extends BasePageComponent implements OnInit  {
  ...
  ngOnInit() {
    ...
    this.httpSv.getallschools()
      ...
      this.form = this.forminstance.getNinthbioclassform();
   ...
   insertstudent(){
     ...
     this.httpSv.addninthbiodata(this.form.value)
      .subscribe(data=>{
