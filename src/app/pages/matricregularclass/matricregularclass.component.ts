...
@Component({
  selector: 'app-matricregularclass',
  templateUrl: './matricregularclass.component.html',
  styleUrls: ['./matricregularclass.component.scss']
})
export class MatricregularclassComponent extends BasePageComponent implements OnInit  {
