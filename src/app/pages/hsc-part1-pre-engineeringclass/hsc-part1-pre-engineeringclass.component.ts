...
@Component({
  selector: 'app-hsc-part1-pre-engineeringclass',
  templateUrl: './hsc-part1-pre-engineeringclass.component.html',
  styleUrls: ['./hsc-part1-pre-engineeringclass.component.scss']
})
export class HscPart1PreEngineeringclassComponent extends BasePageComponent implements OnInit  {
