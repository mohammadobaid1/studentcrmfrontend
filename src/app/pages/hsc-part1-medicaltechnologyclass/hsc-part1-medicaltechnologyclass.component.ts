...
@Component({
  selector: 'app-hsc-part1-medicaltechnologyclass',
  templateUrl: './hsc-part1-medicaltechnologyclass.component.html',
  styleUrls: ['./hsc-part1-medicaltechnologyclass.component.scss']
})
export class HscPart1MedicaltechnologyclassComponent extends BasePageComponent implements OnInit  {
